...
namespace filmHive.API.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class ListFilmController : BaseCRUDControllerAsync<Model.ListFilm, ListFilmSearchObject, ListFilmInsertRequest, ListFilmUpdateRequest>
    {
        public ListFilmController(IListFilmService service)
          : base(service)
        {
        }
    }
